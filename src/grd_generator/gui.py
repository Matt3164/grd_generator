"""Application interactive (PyQt6) : Reflector Studio (AFR).

`build_reflector_result` (pur, sans Qt) construit les champs co/cross par feed
depuis les paramètres réflecteur/feeds de l'interface. Le widget Qt
`ReflectorStudio` pilote cette fonction et le rendu `plot.py`.
"""
